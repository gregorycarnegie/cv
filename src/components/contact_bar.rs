...
#[component]
pub fn ContactBar() -> impl IntoView {
    view! {
        <div class="contact-bar" id="contact">
            <div class="contact-item">
                <div class="contact-icon">
                    <svg viewBox="0 0 72 72" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="contact-text">
                    <a href="https://linkedin.com/in/gregorycarnegie" target="_blank">
                        "linkedin.com/in/gregorycarnegie"
                    </a>
                </div>
            </div>
            <div class="contact-item">
                <div class="contact-icon">
                    <svg viewBox="0 0 2400 2400" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="contact-text">
                    <a href="https://github.com/gregorycarnegie" target="_blank">
                        "github.com/gregorycarnegie"
                    </a>
                </div>
            </div>
        </div>
